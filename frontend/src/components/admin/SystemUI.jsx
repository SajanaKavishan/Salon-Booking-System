...
export function AuthShell({ backgroundImage = '', backgroundStyle, children }) {
  ...
  return (
    <div
      className={`salon-page relative flex min-h-[100dvh] w-full flex-col items-center justify-center bg-cover bg-center bg-no-repeat bg-scroll p-4 md:bg-fixed lg:flex-row lg:p-8 ${backgroundImage}`}
      style={resolvedStyle}
    >
